...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update brand set brandName='$brand' where id='$id'");
...
<div class="controls">
<input type="text" placeholder="Enter brand Name"  name="brand" value="<?php echo  htmlentities($row['brandName']);?>" class="span8 tip" required>
</div>
</div>
