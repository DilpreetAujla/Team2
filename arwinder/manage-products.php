...
<?php $query=mysqli_query($con,"select products.*,category.categoryName,brand.id as bid, brand.brandName as bname from products join category on category.id=products.category join brand on brand.id=products.productCompany");
$cnt=1;
