...
if (isset($_POST['login'])) {
    ...
    if ($num > 0) {
        ...
        $uri = rtrim(dirname($_SERVER['PHP_SELF']), '/\\');
        header("location:http://$host$uri/$extra");
        $_SESSION['errmsg'] = "Email or password incorrect ";
        exit();
    }
}
?>
...
?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" class="form-control unicase-form-control text-input" id="exampleInputPassword1" required="required">
                                </div>
                                <div class="radio outer-xs">
                                    <a href="forgot-password.php" class="forgot-password pull-right" id="forgotPd">Forgot your Password?</a>
                                </div>
