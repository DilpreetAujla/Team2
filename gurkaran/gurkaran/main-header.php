...
?>
<div style="background-color:#002b80;" class="main-header">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                ...
                <div class="logo">
                    <a href="index.php">
                        <img src="assets/images/logo.jpg" alt="dakg" width="80" />
                    </a>
                </div>
            </div>
                ...
                <div class="search-area">
                    <form name="search" method="post" action="search-result.php">
                        <div class="control-group">
                            ...
                            <input style="background-color:white;" class="search-field" placeholder="Search here..." name="product" required="required" />

                            <button style="background-color:#002b80;"  class="search-button" type="submit" name="search" ></button>
                        ...
                        <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner">
                                <div class="total-price-basket">
                                    <span id="cartColor" class="lbl">cart -</span>
                                        ...
                                        <div class="cart-item product-summary">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-7">
                                                    ...
                                                    <div class="price">$<?php echo $price; ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
                                                </div>
